...
class IPS2PioneerVSX923 extends IPSModule
{
	...
	public function ReceiveData($JSONString) {
		...
		$this->SendDebug("ReceiveData Rohdaten", $Data, 0);
			...
			switch($Message) {
				...
				case preg_match('/SSF.*/', $Message) ? $Message : !$Message:
					...
					If ($SpeakerSystem < 3) {
						...
						$ProfilArray = Array();
						$ProfilArray = IPS_GetVariableProfile("IPS2Pioneer.Speaker_".$this->InstanceID);
				...
				case preg_match('/FR.*/', $Message) ? $Message : !$Message:
					...
					$this->SendDebug("ReceiveData", "TunerFrequency: ".$TunerFrequency, 0);
	...
	public function SetHTMLDisplay()
	{
		...
		// Zeile 2
		$HTMLText .= '<tr>';
		    $HTMLText .= '<th class="tg-031e" align="right" width=80 height=30>';
			    // Spalte 1
		    $HTMLText .= '</th>';
